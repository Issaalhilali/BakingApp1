...
public class RecipeActivity extends AppCompatActivity implements RecyclerClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            fm.beginTransaction()
                    .add(R.id.step_list, stepsFragment)
                    .commit();

            playerContainer = findViewById(R.id.exo_player);
            if (playerContainer != null) {
                fm.beginTransaction()
                        .add(R.id.exo_player, playerFragment)
                        .commit();
            }
    ...
    public void onClick(View view, int i) {
        ...
        if (playerContainer != null) {
            ...
            FragmentManager fm = getSupportFragmentManager();
            fm.beginTransaction()
                    .replace(R.id.exo_player, newPlayerFragment)
                    .commit();
        } else {
